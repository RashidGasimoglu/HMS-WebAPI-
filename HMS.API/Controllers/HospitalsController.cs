...
namespace HMS.API.Controllers
{
    ...
    {
        private readonly IGenericService<HospitalDto, Hospital> _service;




        public HospitalsController(IGenericService<HospitalDto, Hospital> service)
        {
            _service = service;
        }
        ...
        [HttpPut("{id:int}")]
        public ActionResult<HospitalDto> Update(int id, [FromBody] HospitalDto obj)
        {
            if (id == 0 || id != obj.Id)
            {
                return BadRequest();
